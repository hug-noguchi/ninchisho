<div class="app_box">
  <div class="app_box_wrapper pc">
    <img src="<?php echo get_template_directory_uri(); ?>/img/bg_app.png" class="bg_app_box">
    <div class="sec_inner">
      <div class="app_image">
        <img src="<?php echo get_template_directory_uri(); ?>/img/appstore_image.png" alt="ベルコメンバーズ">
      </div>
  ...
  <div class="app_box_wrapper sp">
    <img src="<?php echo get_template_directory_uri(); ?>/img/bg_app_sp.png" class="bg_app_box">
    <div class="sec_inner">
      <div class="app_detail">
        <p class="app_detail_title">\ 無料ダウンロード /</p>
        <div class="appstore_logo">
