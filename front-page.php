...
<article class="top">
  <section class="kv_area" id="top_slider">
       <ul class="slide-items">
            <?php
              $args = array(
                'post_type' => 'info', // 投稿タイプのスラッグを指定
                'posts_per_page' => 4, // 投稿件数の指定
                'order' => 'ASC', //昇順で並び替える
                'tax_query' => array(
                  array(
                    'taxonomy' => 'slider', // タクソノミースラッグを指定
                    'field' => 'slug',
                    'terms' => 'on', // タームスラッグを指定
                  )
                )
            ...
            <?php while ($the_query->have_posts()): $the_query->the_post(); ?>
                     ...
                     <li>
                        <a href="<?php the_permalink(); ?>">
                            <div class="slip"><?php the_post_thumbnail(); ?></div>
                            <time datetime="<?php echo get_the_date(); ?>"><?php echo get_the_date(); ?></time>
                            <div class="info_cat_area">
                                <?php
